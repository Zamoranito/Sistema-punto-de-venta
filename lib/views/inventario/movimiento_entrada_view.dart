...
class MovimientoEntradaView extends StatefulWidget {
  const MovimientoEntradaView({
    super.key,
  });

  @override
  State<MovimientoEntradaView> createState() =>
      _MovimientoEntradaViewState();
}

class _MovimientoEntradaViewState
    extends State<MovimientoEntradaView> {
  ...
  void _registrarEntrada() {
    ...
    if (motivo.isEmpty) {
      _mostrarMensaje(
        'Ingresa el motivo de la entrada.',
      );
      return;
    }
        ...
        child: Column(
          ...
          children: [
            SectionTitle(
              ...
              subtitle:
              'Registra el ingreso de productos a una sucursal.',
            ),
                      ...
                      child: SizedBox(
                        ...
                        child: Text(
                          '${producto?.nombre ?? 'Producto desconocido'} - '
                              '${_nombreSucursal(inventario.sucursalId)}',
